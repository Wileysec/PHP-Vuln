...
<div class="am-container">
    <div class="am-alert am-margin-top-lg" data-am-alert>
        ...
        <p><a href="index.php">任务目标一：对该程序进行反序列化分析，在本页面输出flag.php文件代码内容</a></p>
        <p class="am-text-danger">任务目标二：在上一例子基础上绕过正则表达式并在本页面输出flag.php文件代码内容</p>
    </div>
    <?php
        if(isset($_GET['file']) && @$_GET['file']!=''){
            $file = $_GET['file'];
            if(preg_match('/O:\d+:/i',$file)){
                exit("<p class='am-text-danger'>You are attacking!!!</p>");
            }
